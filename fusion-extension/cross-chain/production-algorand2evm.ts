/**
 * Production Algorand to EVM Cross-Chain Swap
 * 
 * This script demonstrates a complete Algorand to EVM cross-chain swap
 * using HTLC (Hash Time-Locked Contract) atomic swaps.
 * 
 * Flow: Algorand (Testnet) → EVM (Polygon Amoy)
 * - User deposits ALGO into Algorand escrow
 * - Resolver deposits POL into EVM escrow
 * - Secret revelation unlocks both deposits
 * - User claims POL from EVM escrow
 */
...
async function runProductionDemo() {
  try {
    ...
    printHeader('🚀 Algorand to EVM Cross-Chain Swap - Production Demo');
    console.log('╔═══════════════════════════════════════════════════════════════╗');
    ...
    console.log('  ➡️ Use Algorand Protocol for fast settlement');
    ...
    console.log('  ⚡ Algorand Escrow Deposit: 0.1 ALGO (REAL)');
    console.log('  🔗 EVM Escrow Claim: 0.01 POL');
